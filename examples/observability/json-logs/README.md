...
This example aligns with the logging and output behavior in the Up and Read-Configuration SPECs: see the containers.dev spec and the containers.dev spec:
