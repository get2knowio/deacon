...
According to the [DevContainer specification](https://containers.dev/implementors/spec/#lifecycle-scripts) and [Up SPEC](https://containers.dev/implementors/spec/), the complete execution order is:
