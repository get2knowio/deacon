...
According to the [Up SPEC](https://containers.dev/implementors/spec/) and implementation in `crates/core/src/progress.rs`, the deacon CLI emits structured progress events throughout the lifecycle execution.
...
- [Up SPEC: Output and Progress](https://containers.dev/implementors/spec/)
