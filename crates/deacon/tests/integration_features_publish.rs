...
/// Test that features publish JSON output includes correct skippedTags structure for all-skipped case
#[test]
fn test_features_publish_json_includes_skipped_tags() {
    use deacon::commands::features_publish_output::{
        PublishFeatureResult, PublishOutput, PublishSummary,
    };
    ...
    // Test the output_publish_result function directly
    // Since it's private, we'll test by checking the JSON structure
