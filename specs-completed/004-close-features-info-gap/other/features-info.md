...
- [ ] Verbose JSON partial failure: include partial fields plus an `errors` object; exit 1.</content>
<parameter name="filePath">/workspaces/deacon-project/worktrees-deacon/004-features-info-cmd/specs/004-close-features-info-gap/checklists/features-info.md